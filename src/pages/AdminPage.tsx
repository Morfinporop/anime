    ...
    <div className="mx-auto max-w-[1100px] px-5 py-8 sm:px-8 sm:py-10 animate-fade-in">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm text-zinc-900 placeholder-zinc-400 outline-none transition-colors focus:border-zinc-400 focus:ring-2 focus:ring-zinc-100"
        />
      </div>
